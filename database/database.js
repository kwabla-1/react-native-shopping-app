...
export const Items = [
    ...
    },
    {
        id: 2,
        category: 'product',
        productName: 'boAt Rockers 450 Bluetooth Headphone',
        productPrice: 1499,
        description:
            'boAt Rockers 450 M is an on-ear wireless headset that has been ergonomically designed to meet the needs of music lovers.',
        isOff: false,
